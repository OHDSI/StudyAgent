# Cohort 1346: Attention-Deficit Hyperactivity Disorder
...
| Field | Value |
|---|---|
| Original complexity tier | T1 |
| Collapsed analysis group | Simple (T1-T2) |
| Concept sets | 1 |
| Resolver retrieval targets | 1 |
| Reference root occurrences | 1 |
| Inclusion rules | 0 |
| Reference status | Pending peer review |

## Source requirement

> All events of Attention-Deficit Hyperactivity Disorder assumed to last 30 days. Events within 1 year are collapsed.
