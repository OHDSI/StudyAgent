...
- both Strategus shells now generate `scripts/08_launch_diagnostics_explorer.R` as an optional second-session launcher for `CohortDiagnostics::launchDiagnosticsExplorer()`
